...
As my first try, I design a Multi-order Gated Aggregation (Moga) in *Efficient Multi-order Gated Aggregation Network* with my teammates in Prof. Stan Z. Li Lab, where robust local representations are efficiently modeled and contexutalized in parellel mimicing what our human visual systems have done.
